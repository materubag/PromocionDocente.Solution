...
ID_CAT | NOM_CAT | DES_CAT | -> ID CATEGORIA | NOMBRE CATEGORIA | DESCRIPCION CATEGORIA |(T1 ..... T5)
...
CREATE TABLE REQUISITOS (
    ...
    TIP_REQ VARCHAR(20), 
    PUN_REQ DECIMAL(4,2)
    ID_CAR NOT NULL REFERENCES CATEGORIAS(ID_CAT)
);
...
TABLAS DE ORGANISMOS U

-- Evaluaciones (DAC)
CREATE TABLE EVALUACIONES (
    ID_EVALUACION SERIAL PRIMARY KEY,
    CED_DOC VARCHAR(10) NOT NULL REFERENCES DOCENTES(CED_DOC),
    PERIODO_EVALUADO VARCHAR(20) NOT NULL,
    TIPO_EVALUACION VARCHAR(50) NOT NULL,
    FECHA_EVALUACION DATE NOT NULL,
    RESULTADO NUMERIC(5,2) NOT NULL,
    OBSERVACIONES VARCHAR(500),
    PDF_EVALUACION VARBINARY(MAX)
);
...
CREATE TABLE OBRAS (
    ...
    OBSERVACIONES VARCHAR(500),
    PDF_PRODUCCION VARBINARY(MAX)
);

-- Cursos de capacitación (DITIC)
CREATE TABLE CURSOS_CAPACITACION (
    ...
    HORAS INT NOT NULL,
    PDF_CURSO VARBINARY(MAX)
);

-- Investigaciones (DIDE)
CREATE TABLE INVESTIGACIONES (
    ...
    ARCHIVO_PDF VARBINARY(MAX),
    TIPO_INVESTIGACION VARCHAR(100) NOT NULL,
    CAMPO_APLICACION VARCHAR(150) NOT NULL
);
